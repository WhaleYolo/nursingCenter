  ...
  <div class="main-container">
    <div style="box-shadow: 0 2px 4px rgba(0, 0, 0, .12), 0 0 6px rgba(0, 0, 0, .04)">
      <div>
        ...
        <!-- 弹出框 -->
        <el-button type="primary" @click="dialogVisible = true;form.staff_type='护工'" v-if="$store.getters.getAdmin">
          新增员工信息</el-button>
      ...
      <!-- 员工信息表 -->
      <el-table :data="nursingWorkerData" stripe style="width: 100%">
